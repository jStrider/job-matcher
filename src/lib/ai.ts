...
const atsScoreSchema = z.object({
  ...
  breakdown: z.object({
    keywordMatch: atsBreakdownItemSchema.default({ score: 0, max: 0, details: "" }),
    skillsAlignment: atsBreakdownItemSchema.default({ score: 0, max: 0, details: "" }),
    experienceRelevance: atsBreakdownItemSchema.default({ score: 0, max: 0, details: "" }),
    jobTitleMatch: atsBreakdownItemSchema.default({ score: 0, max: 0, details: "" }),
    educationMatch: atsBreakdownItemSchema.default({ score: 0, max: 0, details: "" }),
    locationMatch: atsBreakdownItemSchema.default({ score: 0, max: 0, details: "" }),
    languageMatch: atsBreakdownItemSchema.default({ score: 0, max: 0, details: "" }),
    overallFit: atsBreakdownItemSchema.default({ score: 0, max: 0, details: "" }),
  }).default({
    keywordMatch: { score: 0, max: 0, details: "" },
    skillsAlignment: { score: 0, max: 0, details: "" },
    experienceRelevance: { score: 0, max: 0, details: "" },
    jobTitleMatch: { score: 0, max: 0, details: "" },
    educationMatch: { score: 0, max: 0, details: "" },
    locationMatch: { score: 0, max: 0, details: "" },
    languageMatch: { score: 0, max: 0, details: "" },
    overallFit: { score: 0, max: 0, details: "" },
  }),
